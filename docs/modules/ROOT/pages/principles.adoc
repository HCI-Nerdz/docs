...
| ClearType per-monitor honesty
| Monitor pickers must not imply independent RGB/BGR when GDI orientation is session-global and DirectWrite opt-in is uneven
