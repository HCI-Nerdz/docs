...
First engineering proof is a **toy spike** (self-authored tiny PE → hash-matched profile → Linux cache runs) — not a commercial before/after gallery. Detail: systems page *Near-term proof*.
