...
Interactive mock (highlight + dull):
link:https://hci-nerdz.github.io/shell-context-demo/#/manager[shell-context-demo · Project manager].

image::highlight-vs-pipe-linking/highlight-dull-demo.png[Manager focus linked to highlighted DevCentr grid cell,width=100%]
...
* Labels versus wires (xref:an-alternative-to-urls.adoc[An alternative to URLs]) is a different claim (identity vs pretty names) -- do not conflate with on-screen connector graphics.
