...
*Shell context chrome* is the interaction layer for link:https://openshellorg.github.io/docs/shell-architecture/persistent-shell-context.html[persistent shell context @ OpenShellOrg]: the prompt is not only `user@host:path ›` but a row of *editable context tokens* the shell owns and CLIs negotiate with.
...
See OpenShellOrg xref via link:https://openshellorg.github.io/docs/shell-architecture/prompt-spatial-layout.html[prompt spatial layout].
...
When inline terminal widgets are insufficient, the link:https://openshellorg.github.io/docs/shell-architecture/shell-host-and-env-refresh.html[shell-host] (Windows Terminal fork) can promote the focused token to a native dropdown — same promotion rules as terminal-gui-prompts.
...
* link:https://openshellorg.github.io/docs/shell-architecture/prompt-spatial-layout.html[Prompt spatial layout @ OpenShellOrg]
...
* link:https://openshellorg.github.io/docs/shell-architecture/prohelp-gutter.html[Prohelp gutter @ OpenShellOrg]
